...
class HomeView(QWidget):
    """Vista de home con estadísticas generales"""
    ...
    def showEvent(self, event):
        ...
        self._actualizar_estilos_tarjetas()
        self.refresh_data()
    
    def _actualizar_estilos_tarjetas(self):
        """Actualiza los estilos de todas las tarjetas según el tema actual"""
        ...
        # Actualizar estilos de tarjetas pequeñas
        for card in [self.card_total_clientes, self.card_clientes_mora, 
                     self.card_clientes_dia, self.card_total_año]:
            if is_dark:
                card.setStyleSheet("""
                    QFrame {
            ...
            if title_label:
                if is_dark:
                    ...
                    title_label.setStyleSheet("font-size: 14px; color: #475569; font-weight: 600; border: none;")
        
        # Actualizar tarjeta del mes
        if is_dark:
            self.card_total_mes.setStyleSheet("""
                QFrame {
            ...
            """)
            self.card_total_mes.month_label.setStyleSheet("font-size: 16px; color: #94a3b8; font-weight: 500; border: none;")
            self.card_total_mes.findChildren(QLabel)[1].setStyleSheet("font-size: 12px; color: #64748b; border: none;")
        else:
            self.card_total_mes.setStyleSheet("""
                QFrame {
            ...
            """)
            self.card_total_mes.month_label.setStyleSheet("font-size: 16px; color: #1e293b; font-weight: 700; border: none;")
            self.card_total_mes.findChildren(QLabel)[1].setStyleSheet("font-size: 12px; color: #64748b; font-weight: 600; border: none;")
    ...
    def _create_month_card(self) -> QFrame:
        ...
        if is_dark:
            ...
            month_label.setStyleSheet("font-size: 16px; color: #1e293b; font-weight: 700; border: none;")
        ...
        if is_dark:
            ...
            subtitle_label.setStyleSheet("font-size: 12px; color: #64748b; font-weight: 600; border: none;")
    ...
    def _create_info_footer(self) -> QHBoxLayout:
        ...
        # Versión - Leer desde archivo VERSION
        try:
            import os
        ...
        version = QLabel(f"v{version_number}")
    ...
    def refresh_data(self):
        ...
        total_clientes = len([c for c in clientes if c.estado.lower() == 'activo'])
        ...
        # Actualizar tarjetas con valores y colores según el tema
        self.card_total_clientes.value_label.setText(str(total_clientes))
        self.card_total_clientes.value_label.setStyleSheet(f"font-size: 36px; color: {color_azul}; font-weight: 700; border: none;")
        
        self.card_clientes_mora.value_label.setText(str(clientes_mora))
        self.card_clientes_mora.value_label.setStyleSheet(f"font-size: 36px; color: {color_rojo}; font-weight: 700; border: none;")
        
        self.card_clientes_dia.value_label.setText(str(clientes_dia))
        self.card_clientes_dia.value_label.setStyleSheet(f"font-size: 36px; color: {color_verde}; font-weight: 700; border: none;")
        
        self.card_total_año.value_label.setText(f"${total_año:,.0f}")
        self.card_total_año.value_label.setStyleSheet(f"font-size: 36px; color: {color_morado}; font-weight: 700; border: none;")
        ...
        self.card_total_mes.value_label.setStyleSheet(f"font-size: 42px; color: {color_azul}; font-weight: 700; border: none;")
